        ...
        <section class="text-center section-1">
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 col-sm-12">
              ...
              <p>Just need a basic plan? <router-link to="/">Sign up for a free account</router-link>.</p>
              <span class="tab">
                <router-link to="/pricing-monthly">Monthly</router-link>
                <router-link to="/pricing-yearly" class="active">Yearly</router-link>
              </span>
            </div>
            <div class="col-md-3 col-xs-12 col-sm-12"></div>
          </div>
              ...
              <div class="row" style="margin-top: 40px;">
                <div class="col-md-3 col-xs-12 col-sm-12">
                    <div class="col-md-12 col-xs-12 col-sm-12 card" style="margin-top: 20px;">
                      ...
                      <h6 class="text-center" style='margin-top:10px;'><router-link to="/"> Start Free <i class="fas fa-check-circle"></i></router-link></h6>
                    </div>
                </div>
                <div class="col-md-3 col-xs-12 col-sm-12">
                ...
                <div class="col-md-3 col-xs-12 col-sm-12">
                  <div class="col-md-12 col-xs-12 col-sm-12 card" style="margin-top: 20px;">
                    ...
                    <h6 class="text-center" style='margin-top:10px;'><router-link to="/"> Go Premium <i class="fas fa-check-circle"></i></router-link></h6>
                  </div>
                </div>
                <div class="col-md-3 col-xs-12 col-sm-12">
                  <div class="col-md-12 col-xs-12 col-sm-12 card" style="margin-top: 20px;">
