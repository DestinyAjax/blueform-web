        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12 col-sm-12 right-content">
              ...
              <h1>Enjoy phenomenal <br/>feedback rates</h1>
              <p>We allow data collection across all technical scenarios <br>using web forms, offline enabled mobile app and USSD <br>technology.</p>
            </div>
          </div>
        </div>
      </section><hr/>
...
#home-page #first-section .illustration {
...
#home-page .section-3 .right-content ul li {
  margin-bottom: 10px;
}
...
#home-page .section-4 .background {
  background: url(../assets/images/section-4.jpeg);
  background-size: cover;
  background-position: center;
}
...
#home-page .section-4 .left-content ul li {
  margin-bottom: 50px;
}
...
#home-page .section-5 .background {
  background: url(../assets/images/section-5.jpeg);
  background-size: cover;
  background-position: center;
}
...
#home-page .section-6 .background {
  background: url(../assets/images/section-6.jpeg);
  background-size: cover;
  background-position: center;
}
...
#home-page .section-8 {
  background: url(../assets/images/wavy-background.png);
  background-size: cover;
  background-position: center;
  padding-top: 50px;
  padding-bottom: 50px;
...
#home-page .section-8 .right {
  text-align: right;
}

#home-page .section-8 .learn-more {
  background: linear-gradient(90deg, #3C94EE 49%, #1558E5 104.42%);
  font-size: 20px;
  padding: 30px;
  border-radius: 27px;
